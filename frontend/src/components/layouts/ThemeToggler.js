...
export default function ThemeToggler() {
  ...
  return (
    <button
      ...
      className="p-2.5 rounded-full text-slate-500 dark:text-slate-400 hover:text-rose-600 dark:hover:text-rose-400 hover:bg-slate-100 dark:hover:bg-slate-800 transition"
